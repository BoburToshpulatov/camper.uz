...
All our vans are equipped with an electric step.</p>
      ...
      <Button className='buttoninleft' style={{width:'150px',borderRadius:'10px'}} variant="contained">ADD TO CART</Button>
      <Button className='buttoninleft' style={{width:'150px',border:'1.5px solid',borderRadius:'10px'}} variant="outlined">COMPARE</Button>
       </Stack>
        </DescriptionLeft> 
